...
drop policy if exists
  "interpreter video owner upload"
  on storage.objects;
...
drop policy if exists
  "interpreter video owner update"
  on storage.objects;
...
drop policy if exists
  "interpreter video owner delete"
  on storage.objects;
...
drop policy if exists
  "interpreter video authorized read"
  on storage.objects;

create policy "interpreter video authorized read"
  on storage.objects
  for select
  to authenticated
  using (
